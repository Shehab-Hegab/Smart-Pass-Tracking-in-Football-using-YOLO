...
def draw_team_ball_control(frame,ball_control):
        ...
        total_possession = ball_control[MODEL_CLASSES["team1"]] + ball_control[MODEL_CLASSES["team2"]]
        
        if total_possession > 0:
            team_1 = ball_control[MODEL_CLASSES["team1"]] / total_possession
            team_2 = ball_control[MODEL_CLASSES["team2"]] / total_possession
        else:
            team_1 = 0.5  # 50-50 when no possession data
            team_2 = 0.5
